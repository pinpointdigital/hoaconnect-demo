          ...
          <div className="relative rounded-card overflow-hidden border border-ink-900/8 shadow-elev1">
            ...
            <div className="relative h-48 md:h-56">
              ...
              <button
                ...
                className="absolute top-4 right-4 bg-white/20 hover:bg-white/30 backdrop-blur-sm rounded-full p-2 transition-colors duration-200 text-white z-20 cursor-pointer"
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            {(currentRole === 'management-company' || currentRole === 'captain') && (
              <div className="lg:col-span-1 rounded-card border border-ink-900/8 bg-white shadow-elev1 p-6">
                ...
                <div 
                  id="hoa-ai-assistant" 
                  className="relative w-full h-[400px] rounded-lg border border-neutral-200 overflow-hidden flex items-center justify-center"
                  style={{
                    backgroundImage: 'url(/HOAConnectAssistantDemoPlaceholder.png)',
